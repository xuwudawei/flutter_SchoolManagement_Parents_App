...
class FridayTimeTable extends StatefulWidget {
  @override
  _FridayTimeTableState createState() => _FridayTimeTableState();
}

class _FridayTimeTableState extends State<FridayTimeTable> {
  @override
  var selectedNav = 0;
